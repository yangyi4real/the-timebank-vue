...
export default {
  ...
  methods: {
    ...
    msgDetailsClicked (item) {
      this.$router.push(`/personal/msg/${item.title}/${item.content}`)
    }
  },
  mounted () {
    this.loadData()
...
<style scoped>
  ...
  .msg .msg-list2 .msg-list-text2{font-size:0.16rem;font-family:PingFangSC-Regular;font-weight:400;color:rgba(51,51,51,1);padding-top: 0.17rem;}
</style>
